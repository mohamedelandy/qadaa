...
export function PrayerRow(props: PrayerRowProps) {
  ...
  return (
    <Animated.View style={entranceStyles}>
      <View
        testID={`dashboard-${prayerKey}-row`}
        style={[styles.container, isDone && styles.containerDone]}
      >
        {isDone && <View style={styles.doneAccentBar} pointerEvents="none" />}
          ...
          <View style={styles.leftSection}>
            ...
            <View style={styles.info}>
              ...
              <View style={styles.statusRow}>
                ...
                {remaining > 0 && (
                  <Text
                    testID={`dashboard-${prayerKey}-remaining`}
                    style={styles.remainingTextUrgent}
                  >
